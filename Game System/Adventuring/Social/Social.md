...
Disposition is a [[Resources|resource]] that changes due to interactions with you, during social encounters or through your fame, or infamy.

### First Impression
Usually, NPCs start at indifferent, unless there is a reason for them not to.
When you first meet with someone, make a *first impressions* [[Resources#Resource Modification as Check Result|check]] (relevant [[#Social ../../Characters/Aspects/Aspects Aspects|social aspect]] + [[../../Characters/Attributes/Presence (PRE)|PRE]]) to modify their initial attitude towards the direction you want.
...
When commanding others, either by authority, inspiration, or planning, you make can make a check that will provide some bonuses, equal to your  [[../../Gameplay/Gameplay#Difficulty & Degree of Success/Failure (DoS/DoF)|degree of success]], that your allies can use later within the same [[Timekeeping#Turn|turn]]/[[Timekeeping#Encounter|encounter]].
