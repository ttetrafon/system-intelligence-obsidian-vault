...
### Defensive Check
Whenever you suffer [[Timekeeping#Damage|damage]] you are allowed an appropriate defensive check. The defensive check is a [[#Category/Trait Score|trait]] check. The [[../../Gameplay/Gameplay#Difficulty & Degree of Success/Failure (DoS/DoF)|DoS]] of this check reduces the damage on 1-1 rate, which may reduce the severity of the incoming [[../Health/Health#Injury|injury]]/[[../Health/Health#Effects|effect]], or even outright negate it.
