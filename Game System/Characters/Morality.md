...
Morality is usually rolled as part of [[../Gameplay.md|normal checks]], especially during opposed checks against others.
...
In this case you roll both of the moral scores in the axis in question, and the one with the best [[../Gameplay.md#Difficulty & Degree of Success/Failure (DoS/DoF)|DoS]] wins. You must then follow according to your character's morals and not your own will as a player.
...
If so, you make an [[../Gameplay/Resources.md#Accumulation|accumulation]] check to increase that morality score.
...
During downtime you can spend time in various activities with the purpose of increasing or lowering one of your morality trait scores. You make a check once per cycle as per the guidelines above. Each attempt to change your morals takes one [[../Gameplay/Timekeeping.md#Downtime|downtime activity]].