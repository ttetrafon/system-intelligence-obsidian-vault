...
If so, you make an [[Resources#Accumulation|accumulation]] check to increase that morality score.
...
During downtime you can spend time in various activities with the purpose of increasing or lowering one of your morality trait scores. You make a check once per cycle as per the guidelines above. Each attempt to change your morals takes one [[Timekeeping#Downtime|downtime activity]].