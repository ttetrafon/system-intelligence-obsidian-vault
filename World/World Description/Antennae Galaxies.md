...
Section: 
Room: 
description: "![Antennae Galaxies](https://en.wikipedia.org/wiki/Antennae_Galaxies)"
...
WHERE Plane = "Prime" AND Galaxy = "Antennae Galaxies" AND file.name != "Antennae Galaxies"
