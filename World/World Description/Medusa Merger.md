...
Section: 
Room: 
description: "![Medusa Merger](https://en.wikipedia.org/wiki/NGC_4194)"
...
WHERE Plane = "Prime" AND Galaxy = "Medusa Merger" AND file.name != "Medusa Merger"
