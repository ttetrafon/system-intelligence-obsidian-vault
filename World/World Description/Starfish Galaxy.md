...
Section: 
Room: 
description: "![[Starfish Galaxy](https://en.wikipedia.org/wiki/NGC_6240)"
...
WHERE Plane = "Prime" AND Galaxy = "Starfish Galaxy" AND file.name != "Starfish Galaxy"
